...
import com.example.adv160420002uts.viewmodel.ListViewModelDoctor
import com.example.adv160420002uts.viewmodel.ListViewModelMedicine

class DoctorFragment : Fragment() {
    private lateinit var viewModel: ListViewModelDoctor
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(ListViewModelDoctor::class.java)
        viewModel.refresh()
